...
Use with `REPRO_USE_REFERENCE=1 bash scripts/reproduce_sinica2026.sh` when the source video is not downloaded.
...
```bash
cp outputs/tapko/jedi_submissions_eval/tapko_results.csv data/repro/sinica2026/reference/
